...
const SQUADS = {
  ...
  DC:[{n:'KL Rahul',r:'WK',c:10.0},{n:'Mitchell Starc',r:'BOWL',c:9.5},{n:'Axar Patel',r:'AR',c:9.0},{n:'Kuldeep Yadav',r:'BOWL',c:9.0},{n:'David Miller',r:'BAT',c:8.5},{n:'Tristan Stubbs',r:'WK',c:7.5},{n:'Karun Nair',r:'BAT',c:7.5},{n:'Pathum Nissanka',r:'BAT',c:7.5},{n:'T. Natarajan',r:'BOWL',c:7.5},{n:'Prithvi Shaw',r:'BAT',c:7.0},{n:'Ashutosh Sharma',r:'AR',c:7.0},{n:'Sameer Rizvi',r:'AR',c:6.5}],`n  KKR:[{n:'Ajinkya Rahane',r:'BAT',c:8.0},{n:'Cameron Green',r:'AR',c:9.5},{n:'Sunil Narine',r:'AR',c:9.0},{n:'Varun Chakravarthy',r:'BOWL',c:8.5},{n:'Rinku Singh',r:'BAT',c:8.5},{n:'Finn Allen',r:'WK',c:8.0},{n:'Rachin Ravindra',r:'AR',c:8.0},{n:'Harshit Rana',r:'BOWL',c:7.5},{n:'Akash Deep',r:'BOWL',c:7.5},{n:'Ramandeep Singh',r:'AR',c:6.5},{n:'Rovman Powell',r:'BAT',c:7.5},{n:'Vaibhav Arora',r:'BOWL',c:7.0}],`n  SRH:[{n:'Pat Cummins',r:'BOWL',c:9.5},{n:'Travis Head',r:'BAT',c:9.5},{n:'Abhishek Sharma',r:'AR',c:8.5},{n:'Heinrich Klaasen',r:'WK',c:9.0},{n:'Ishan Kishan',r:'WK',c:8.5},{n:'Liam Livingstone',r:'AR',c:8.0},{n:'Harshal Patel',r:'AR',c:7.5},{n:'Shivam Mavi',r:'BOWL',c:7.0},{n:'Zeeshan Ansari',r:'BOWL',c:6.5},{n:'Brydon Carse',r:'AR',c:7.0},{n:'Nitish Kumar Reddy',r:'AR',c:8.0},{n:'Kamindu Mendis',r:'AR',c:7.5}],`n  PBKS:[{n:'Shreyas Iyer',r:'BAT',c:9.5},{n:'Arshdeep Singh',r:'BOWL',c:9.0},{n:'Yuzvendra Chahal',r:'BOWL',c:8.5},{n:'Marcus Stoinis',r:'AR',c:8.5},{n:'Prabhsimran Singh',r:'WK',c:8.0},{n:'Marco Jansen',r:'AR',c:8.0},{n:'Lockie Ferguson',r:'BOWL',c:8.0},{n:'Shashank Singh',r:'BAT',c:7.5},{n:'Nehal Wadhera',r:'BAT',c:7.0},{n:'Priyansh Arya',r:'AR',c:7.0},{n:'Musheer Khan',r:'AR',c:7.0},{n:'Azmatullah Omarzai',r:'AR',c:7.0}],`n  RCB:[{n:'Virat Kohli',r:'BAT',c:10.5},{n:'Rajat Patidar',r:'BAT',c:9.0},{n:'Josh Hazlewood',r:'BOWL',c:9.0},{n:'Phil Salt',r:'WK',c:8.5},{n:'Tim David',r:'AR',c:8.5},{n:'Krunal Pandya',r:'AR',c:8.0},{n:'Devdutt Padikkal',r:'BAT',c:8.0},{n:'Venkatesh Iyer',r:'AR',c:8.0},{n:'Bhuvneshwar Kumar',r:'BOWL',c:8.0},{n:'Yash Dayal',r:'BOWL',c:7.0},{n:'Jacob Bethell',r:'AR',c:7.5},{n:'Romario Shepherd',r:'AR',c:7.0}],`n  DC:[{n:'KL Rahul',r:'WK',c:10.0},{n:'Mitchell Starc',r:'BOWL',c:9.5},{n:'Axar Patel',r:'AR',c:9.0},{n:'Kuldeep Yadav',r:'BOWL',c:9.0},{n:'David Miller',r:'BAT',c:8.5},{n:'Tristan Stubbs',r:'WK',c:7.5},{n:'Karun Nair',r:'BAT',c:7.5},{n:'Pathum Nissanka',r:'BAT',c:7.5},{n:'T. Natarajan',r:'BOWL',c:7.5},{n:'Prithvi Shaw',r:'BAT',c:7.0},{n:'Ashutosh Sharma',r:'AR',c:7.0},{n:'Sameer Rizvi',r:'AR',c:6.5}],`n  KKR:[{n:'Ajinkya Rahane',r:'BAT',c:8.0},{n:'Cameron Green',r:'AR',c:9.5},{n:'Sunil Narine',r:'AR',c:9.0},{n:'Varun Chakravarthy',r:'BOWL',c:8.5},{n:'Rinku Singh',r:'BAT',c:8.5},{n:'Finn Allen',r:'WK',c:8.0},{n:'Rachin Ravindra',r:'AR',c:8.0},{n:'Harshit Rana',r:'BOWL',c:7.5},{n:'Akash Deep',r:'BOWL',c:7.5},{n:'Ramandeep Singh',r:'AR',c:6.5},{n:'Rovman Powell',r:'BAT',c:7.5},{n:'Vaibhav Arora',r:'BOWL',c:7.0}],`n  SRH:[{n:'Pat Cummins',r:'BOWL',c:9.5},{n:'Travis Head',r:'BAT',c:9.5},{n:'Abhishek Sharma',r:'AR',c:8.5},{n:'Heinrich Klaasen',r:'WK',c:9.0},{n:'Ishan Kishan',r:'WK',c:8.5},{n:'Liam Livingstone',r:'AR',c:8.0},{n:'Harshal Patel',r:'AR',c:7.5},{n:'Shivam Mavi',r:'BOWL',c:7.0},{n:'Zeeshan Ansari',r:'BOWL',c:6.5},{n:'Brydon Carse',r:'AR',c:7.0},{n:'Nitish Kumar Reddy',r:'AR',c:8.0},{n:'Kamindu Mendis',r:'AR',c:7.5}],`n  PBKS:[{n:'Shreyas Iyer',r:'BAT',c:9.5},{n:'Arshdeep Singh',r:'BOWL',c:9.0},{n:'Yuzvendra Chahal',r:'BOWL',c:8.5},{n:'Marcus Stoinis',r:'AR',c:8.5},{n:'Prabhsimran Singh',r:'WK',c:8.0},{n:'Marco Jansen',r:'AR',c:8.0},{n:'Lockie Ferguson',r:'BOWL',c:8.0},{n:'Shashank Singh',r:'BAT',c:7.5},{n:'Nehal Wadhera',r:'BAT',c:7.0},{n:'Priyansh Arya',r:'AR',c:7.0},{n:'Musheer Khan',r:'AR',c:7.0},{n:'Azmatullah Omarzai',r:'AR',c:7.0}],`n  RCB:[{n:'Virat Kohli',r:'BAT',c:10.5},{n:'Rajat Patidar',r:'BAT',c:9.0},{n:'Josh Hazlewood',r:'BOWL',c:9.0},{n:'Phil Salt',r:'WK',c:8.5},{n:'Tim David',r:'AR',c:8.5},{n:'Krunal Pandya',r:'AR',c:8.0},{n:'Devdutt Padikkal',r:'BAT',c:8.0},{n:'Venkatesh Iyer',r:'AR',c:8.0},{n:'Bhuvneshwar Kumar',r:'BOWL',c:8.0},{n:'Yash Dayal',r:'BOWL',c:7.0},{n:'Jacob Bethell',r:'AR',c:7.5},{n:'Romario Shepherd',r:'AR',c:7.0}],`n  LSG:[{n:'Rishabh Pant',r:'WK',c:10.5},{n:'Mohammad Shami',r:'BOWL',c:9.5},{n:'Mitchell Marsh',r:'AR',c:9.0},{n:'Nicholas Pooran',r:'WK',c:8.5},{n:'Wanindu Hasaranga',r:'AR',c:8.5},{n:'Anrich Nortje',r:'BOWL',c:8.5},{n:'Aiden Markram',r:'AR',c:8.0},{n:'Mayank Yadav',r:'BOWL',c:8.0},{n:'Josh Inglis',r:'WK',c:7.5},{n:'Avesh Khan',r:'BOWL',c:7.5},{n:'Abdul Samad',r:'AR',c:7.0},{n:'Ayush Badoni',r:'AR',c:7.0}],
};

const MATCH_OPTIONS = [
  { id: 'CSK_RR_2026_M03', label: 'CSK vs RR — Mar 30 (Live)', teams: ['CSK', 'RR'] },
  { id: 'GT_PBKS_2026_M04', label: 'GT vs PBKS — Mar 30', teams: ['GT', 'PBKS'] },
  { id: 'LSG_DC_2026_M05', label: 'LSG vs DC — Apr 1', teams: ['LSG', 'DC'] },
  { id: 'MI_DC_2026_M08',  label: 'MI vs DC — Apr 4',  teams: ['MI', 'DC'] },
];
